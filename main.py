...
def get_stock_price(ticker):
    return str(yf.Ticker(ticker).history(period="1yr").iloc[-1].Close)

def calculate_SMA(ticker, window):
    data = yf.Ticker(ticker).history(period="1yr").Close
...
function_list = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                "ticker": {
                    "type": "string",
                    "description": "This is the stock ticker symbol for a company (e.g., AAPL for APPLE)."
                }
            },
            "required": ['ticker']
        }
     ...
     {
        "name": "calculate_RSI",
        "description": "Calculates the RSI for a  stock given the ticker.",
        "parameters": {
            "type": "object",
            "properties": {
                "ticker": {
     ...
     {
        "name": "calculate_MACD",
        "description": "Calculates the MACD for a stock given the ticker.",
        "parameters": {
            "type": "object",
            "properties": {
                "ticker": {
     ...
     },
     {
        ...
        "description": "Plots the stock price for the last year given the ticker symbol of a company.",
        "parameters": {
            "type": "object",
            "properties": {
                "ticker": {
